...
model ConstantPhotThotTcoldTwallAlgebPcold
...
equation
  wInCold = wCold[1];
  wInHot = wHot[1];
  Tcold[:] = {450 + 273.15, 456.7421 + 273.15, 467.47153 + 273.15, 484.40054 + 273.15, 510.78116 + 273.15, 551.2044 + 273.15, 611.9187 + 273.15};
...
end ConstantPhotThotTcoldTwallAlgebPcold;
